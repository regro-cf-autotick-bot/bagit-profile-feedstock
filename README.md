...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/bagit-profile-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=11852&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/bagit-profile-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `bagit-profile` can be installed with:

```
conda install bagit-profile
```

It is possible to list all of the versions of `bagit-profile` available on your platform with:
